          ...
          >
            ...
            <div className={styles.textContainer}>
              ...
              <p>
                ...
                showcases a user-friendly interface and a streamlined purchasing
                pathway, enhancing overall user engagement. Notably, it features
                a comprehensive dashboard for restaurant owners, offering them
                the flexibility to effortlessly modify, add, or remove products.
                The integration of Google Places API ensures precise location
                services, while Cloudinary integration facilitates convenient
                photo uploads through an intuitive drag-and-drop system. These
                advanced features collectively guarantee an exceptional user
                experience.
              </p>
              ...
              <p>
                ...
                development of web and mobile apps with its minimalist approach
                and robust features.
              </p>
              <p>
